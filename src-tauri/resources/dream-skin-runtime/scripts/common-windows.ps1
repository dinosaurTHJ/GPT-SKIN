...
function ConvertTo-DreamSkinUtcTimestamp {
...
function Stop-DreamSkinRecordedInjector {
  ...
  $recordedStartedAt = ConvertTo-DreamSkinUtcTimestamp -Value $State.injectorStartedAt
  $startMatches = -not $recordedStartedAt -or $startedAt -eq $recordedStartedAt
