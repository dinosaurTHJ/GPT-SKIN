...
## Corpus Check
- 111 files · ~406,960 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2326 nodes · 4826 edges · 154 communities (135 shown, 19 thin omitted)
...
- `rejects_active_svg_content()` --calls--> `validate_svg()`  [INFERRED]
  src-tauri/src/theme.rs → crates/theme-protocol/src/lib.rs
...
Cohesion: 0.05
Nodes (74): normalizeThemeColor(), ascii(), classifyImageDimensions(), jpegDimensions(), pngDimensions(), readImageMetadata(), readRawDimensions(), SOF_MARKERS (+66 more)
...
Cohesion: 0.07
Nodes (53): Assert-DreamSkinCodexDirectLaunchTarget(), Assert-DreamSkinRuntimeTree(), Assert-DreamSkinTrustedNodeImage(), ConvertFrom-DreamSkinUtf8Base64(), ConvertTo-DreamSkinArgumentLine(), ConvertTo-DreamSkinCodexInstall(), ConvertTo-DreamSkinUtcTimestamp(), Get-DreamSkinCdpBrowserIdentity() (+45 more)

### Community 6 - "codex.rs"
Cohesion: 0.05
Nodes (22): Drop, clears_preview_status_after_codex_exits(), detects_installed_chatgpt_package(), detects_installed_codex(), exited_test_instance(), expired_development_preview_clears_its_session(), get_theme_asset_response(), keeps_preview_during_brief_target_loss() (+14 more)
...
Cohesion: 0.12
Nodes (37): Dictionary, OwnedHandle, activate_windows_store_app(), activate_windows_store_app_attached(), activate_windows_store_app_with_ownership(), chatgpt_app_loads_session_asset_urls(), CodexError, CodexInstallation (+29 more)

### Community 9 - "theme.rs"
Cohesion: 0.08
Nodes (31): selector_lists_preserve_nested_function_commas(), validate_css(), IntoIterator, Item, accepts_controlled_asset_mount_selectors(), accepts_namespaced_keyframes_and_rejects_global_animation_names(), accepts_only_supported_color_schemes(), accepts_only_supported_runtime_views() (+23 more)
...
### Community 11 - "lib.rs"
Cohesion: 0.14
Nodes (34): is_hex_color(), is_valid_author_id(), is_valid_locale(), is_valid_theme_id(), parse_attribute_value(), referenced_asset_paths(), BTreeMap, HashSet (+26 more)
...
### Community 18 - "String"
Cohesion: 0.12
Nodes (30): Fn, assert_runtime_urls_are_local(), build_runtime_config(), build_runtime_config_with(), builds_controlled_asset_slot_runtime_config(), builds_home_prompt_and_conversation_banner_runtime_config(), collect_runtime_asset_paths(), collect_runtime_assets() (+22 more)
...
Cohesion: 0.21
Nodes (14): installs_and_loads_signed_online_theme(), is_sha256(), online_theme_uses_device_encrypted_cache(), platform_verifying_key(), PathBuf, Result, Self, VerifyingKey (+6 more)
...
Cohesion: 0.19
Nodes (23): Assert-DreamSkinCommunityActiveBaseline(), Confirm-DreamSkinCommunityApply(), Ensure-DreamSkinCommunityActiveBaseline(), Format-DreamSkinCommunitySuccessMessage(), Get-DreamSkinCommunityActiveState(), Get-DreamSkinCommunityHttpResponse(), Get-DreamSkinCommunityStartFailureMessage(), Get-DreamSkinCommunityText() (+15 more)
...
Cohesion: 0.17
Nodes (20): AtomicU64, Default, dropping_test_instance_only_terminates_its_process_group(), find_codex_target(), IdleInstance, normalize_theme_locale(), replace_theme_package_preview(), Mutex (+12 more)
...
Cohesion: 0.21
Nodes (24): Instant, Message, S, applies_and_restores_external_theme(), dispatch_escape(), dispatch_mouse_click(), dispatch_mouse_move(), evaluate() (+16 more)

### Community 31 - "properties"
Cohesion: 0.15
Nodes (15): additionalProperties, properties, type, bannerLocalization, heroLocalization, $ref, $ref, additionalProperties (+7 more)

### Community 32 - "Result"
Cohesion: 0.18
Nodes (28): extension(), is_safe_relative_path(), normalize_package_path(), read_archive(), read_development_directory(), read_development_entries(), Display, Error (+20 more)
...
### Community 34 - "asset"
Cohesion: 0.12
Nodes (17): additionalProperties, properties, $ref, required, type, properties, additionalProperties, properties (+9 more)

### Community 35 - "properties"
Cohesion: 0.09
Nodes (23): description, $ref, $ref, const, description, const, $ref, properties (+15 more)
...
Cohesion: 0.27
Nodes (11): Assert-DreamSkinPort(), Invoke-DreamSkinNative(), Read-DreamSkinState(), Ensure-ManagerSession(), Get-ManagerSession(), Invoke-ManagerRestore(), Start-ManagerSession(), Get-DreamSkinLiveSessionContext() (+3 more)

### Community 38 - "String"
Cohesion: 0.13
Nodes (22): AtomicBool, JoinHandle, SocketAddr, apply_theme(), builds_msix_activation_command_line_with_isolated_profile(), DevToolsTarget, DevToolsVersion, isolated_launch_arguments() (+14 more)
...
### Community 53 - ".start"
Cohesion: 0.23
Nodes (21): Copy-DreamSkinActiveThemeSnapshot(), Copy-DreamSkinImportedThemeSnapshot(), Set-DreamSkinActiveThemeFromSnapshot(), Get-DreamSkinNodeRuntime(), Invoke-ManagerInjection(), Set-ManagerOpacity(), Assert-DreamSkinImageFile(), Assert-DreamSkinSafeCssFile() (+13 more)
...
Cohesion: 0.50
Nodes (4): additionalProperties, required, type, assetSlot
...
Cohesion: 0.33
Nodes (7): Duration, get_json(), get_json_with_timeout(), page_lease_renewal_is_bound_to_session_and_hard_deadline(), renew_theme_lease(), renew_theme_lease_expression(), T
...
Cohesion: 0.14
Nodes (16): additionalProperties, properties, required, type, conversationBanner, hero, enum, $ref (+8 more)
...
- **Why does `$defs` connect `$defs` to `experienceLocalization`, `asset`, `divider`, `properties`, `conversationBanner`, `name`, `homePrompt`, `nonEmptyText`, `Invoke-DreamSkinCommunityStartAndVerify`, `title`, `preview`, `themeName`, `properties`, `theme.schema.json`, `access`?**
